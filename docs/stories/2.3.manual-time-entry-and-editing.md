...
- [ ] Task 1: Create TimeEntryForm component (AC: 2, 3, 7)
...
- [ ] Task 2: Create TimeEntryModal component (AC: 1, 2, 3, 7)
...
- [ ] Task 3: Add "Add Time" button to TaskCard (AC: 1)
...
- [ ] Task 4: Create TimeEntryList component (AC: 9)
...
- [ ] Task 5: Create TimeEntryListItem component with edit/delete (AC: 4, 6, 9)
...
- [ ] Task 6: Implement manual time entry creation (AC: 2, 3, 5)
...
- [ ] Task 7: Implement time entry editing (AC: 4, 5, 8)
...
- [ ] Task 8: Implement time entry deletion (AC: 4, 8)
...
- [ ] Task 9: Update TimeEntryRepository with edit/delete methods (AC: 4, 5)
...
- [ ] Task 10: Add date/time selection for manual entries (AC: 5)
...
- [ ] Task 11: Integrate TimeEntryList into TaskCard or modal (AC: 9)
...
- [ ] Task 12: Ensure manual entry doesn't interfere with active timer (AC: 10)
...
- [ ] Task 13: Update TimerDisplay to reflect manual entries (AC: 8)
...
- [ ] Task 14: Visual distinction for manual entries (AC: 6)
...
- [ ] Task 15: Unit tests for TimeEntryForm (AC: 2, 3, 7)
