  ...
  return (
    <>
      <div
        ...
        onClick={onClick}
        className={`
          bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600 p-4 mb-3
          cursor-pointer transition-all duration-200
          hover:shadow-md hover:scale-[1.02] dark:hover:bg-gray-700
      ...
      >
        ...
        <div className="flex items-start justify-between gap-2 mb-2">
          <h3
            ...
            className="text-base font-semibold text-gray-900 dark:text-gray-100 line-clamp-2 flex-1"
          >
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {task.isBillable ? (
              ...
              <button
                ...
                onKeyDown={handleBillableToggleKeyDown}
                disabled={isTogglingBillable}
                className="px-2 py-1 text-xs font-medium text-gray-500 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 rounded-full border border-gray-300 dark:border-gray-600 hover:border-green-300 dark:hover:border-green-600 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 transition-colors disabled:opacity-50"
        ...
        <div className="mt-2 pt-2 border-t border-gray-100 dark:border-gray-700">
          <div className="flex items-center justify-between gap-2 mb-1">
            ...
            <button
              ...
              className="px-2 py-1 text-xs font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400"
